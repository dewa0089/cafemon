...
export default {
  ...
  methods: {
    ...
    hapusKeranjang(_id) {
      axios
        .delete("https://testapi-pink.vercel.app/keranjang/" + _id)
        .then(() => {
          ...
          axios
            .get("https://testapi-pink.vercel.app/keranjang")
    ...
    checkout() {
      ...
      if (this.pesan.nama && this.pesan.nomor_meja) {
        ...
        axios
          .post("https://testapi-pink.vercel.app/order", this.pesan)
          .then(() => {

            // Hapus Semua Keranjang 
            this.keranjangs.map(function (item) {
              return axios
                .delete("https://testapi-pink.vercel.app/keranjang/" + item._id)
                .catch((error) => console.log(error));
            });
